...
export class CreateFirstMigration1649687873238 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "teams_users" ADD CONSTRAINT "FK_29718c15b653166d708c49b357b" FOREIGN KEY ("team_id") REFERENCES "teams"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "teams_users" DROP CONSTRAINT "FK_2a578f7a5be3b6bec99bfb8d6ac"`);
        await queryRunner.query(`ALTER TABLE "teams_users" DROP CONSTRAINT "FK_29718c15b653166d708c49b357b"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_2a578f7a5be3b6bec99bfb8d6a"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_29718c15b653166d708c49b357"`);
